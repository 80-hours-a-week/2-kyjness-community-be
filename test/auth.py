def test_signup_success(client):
    res = client.post(
        "/v1/auth/signup",
        json={"email": "signup_ok@example.com", "password": "password12", "nickname": "signupuser"},
    )
...
def test_signup_duplicate_email(client):
    client.post(
        "/v1/auth/signup",
        json={"email": "dup_email@example.com", "password": "password12", "nickname": "user1"},
    )
    res = client.post(
        "/v1/auth/signup",
        json={"email": "dup_email@example.com", "password": "password12", "nickname": "user2"},
    )
...
def test_signup_duplicate_nickname(client):
    client.post(
        "/v1/auth/signup",
        json={"email": "user_a@example.com", "password": "password12", "nickname": "samenick"},
    )
    res = client.post(
        "/v1/auth/signup",
        json={"email": "user_b@example.com", "password": "password12", "nickname": "samenick"},
    )
    assert res.status_code == 409
...
def test_login_success(client):
    client.post(
        "/v1/auth/signup",
        json={"email": "login_ok@example.com", "password": "password12", "nickname": "loginuser"},
    )
    res = client.post(
        "/v1/auth/login",
...
def test_login_wrong_password(client):
    client.post(
        "/v1/auth/signup",
        json={"email": "wrong_pw@example.com", "password": "password12", "nickname": "wrongpw"},
    )
    res = client.post(
        "/v1/auth/login",
...
def test_me_success(client):
    client.post(
        "/v1/auth/signup",
        json={"email": "me_ok@example.com", "password": "password12", "nickname": "meuser"},
    )
    login = client.post("/v1/auth/login", json={"email": "me_ok@example.com", "password": "password12"})
    assert login.status_code == 200
    cookies = {"session_id": login.cookies.get("session_id")}
    res = client.get("/v1/auth/me", cookies=cookies)
    assert res.status_code == 200
    assert res.json()["code"] == "AUTH_SUCCESS"
...
def test_logout_then_me_unauthorized(client, auth_cookies):
    ...
    res = client.get("/v1/auth/me", cookies=auth_cookies)
    assert res.status_code == 401
